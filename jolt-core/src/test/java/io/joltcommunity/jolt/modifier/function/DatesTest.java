...
public class DatesTest extends AbstractTester {
    ...
    public Iterator<Object[]> getTestCases() {
        ...
        testCases.add(new Object[]{"format-from-pattern-invalid", FORMAT, new Object[]{"2000-01-01", "ABCD", "yyyy-MM-dd", "UTC"}, Optional.empty()});
        testCases.add(new Object[]{"format-to-pattern-invalid", FORMAT, new Object[]{"2000-01-01", "yyyy-MM-dd", "ABCD", "UTC"}, Optional.empty()});
        testCases.add(new Object[]{"format-pattern-numeric", FORMAT, new Object[]{"2000-01-01", "yyyy-MM-dd", 1, "UTC"}, Optional.empty()});
