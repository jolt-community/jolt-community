...
public class DatesTest extends AbstractTester {
    ...
    public Iterator<Object[]> getTestCases() {
        ...
        testCases.add(new Object[]{"format-date-only", FORMAT, new Object[]{"2000-01-01", "yyyy-MM-dd", "yyyyMMdd", "UTC", "UTC"}, Optional.of("20000101")});
        testCases.add(new Object[]{"format-with-time", FORMAT, new Object[]{"2000-01-01T12:30:45", "yyyy-MM-dd'T'HH:mm:ss", "yyyy-MM-dd HH:mm:ss", "UTC", "UTC"}, Optional.of("2000-01-01 12:30:45")});
        testCases.add(new Object[]{"format-with-time", FORMAT, new Object[]{"2000-01-01T12:30:45", "yyyy-MM-dd'T'HH:mm:ss", "yyyy-MM-dd HH:mm:ss", "Europe/Paris", "Europe/Paris"}, Optional.of("2000-01-01 12:30:45")});
        testCases.add(new Object[]{"format-to-iso8601", FORMAT, new Object[]{"20000101", "yyyyMMdd", "yyyy-MM-dd'T'HH:mm:ss'Z'", "UTC", "UTC"}, Optional.of("2000-01-01T00:00:00Z")});
        ...
        testCases.add(new Object[]{"format-timezone-missing", FORMAT, new Object[]{"2000-01-01", "yyyy-MM-dd"}, Optional.empty()});
        testCases.add(new Object[]{"format-from-pattern-invalid", FORMAT, new Object[]{"2000-01-01", "ABCD", "yyyy-MM-dd", "UTC", "UTC"}, Optional.empty()});
        testCases.add(new Object[]{"format-to-pattern-invalid", FORMAT, new Object[]{"2000-01-01", "yyyy-MM-dd", "ABCD", "UTC", "UTC"}, Optional.empty()});
        testCases.add(new Object[]{"format-pattern-numeric", FORMAT, new Object[]{"2000-01-01", "yyyy-MM-dd", 1, "UTC", "UTC"}, Optional.empty()});
